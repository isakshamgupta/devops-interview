# Git & Version Control Interview Questions (Topic-wise Collection)
...
- If I have created dev branch and deployed on dev env, if I want to move that code to staging env, how to do that? *(AlignedAutomation)*
